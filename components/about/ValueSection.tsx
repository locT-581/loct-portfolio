...
export default async function ValueSection() {
	...
	return (
		<section className="px-6 md:px-[8%] py-32 bg-[#F2F2F2] dark:bg-[#111111] border-t border-black/10 dark:border-white/10">
			{/* Top Section */}
			<div className="flex flex-col gap-10 mb-20 lg:mb-32">
				...
				<div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-20 items-end">
					<div className="lg:col-span-6 xl:col-span-7">
						<h2 className="text-5xl md:text-7xl lg:text-[110px] font-switzer leading-[1.1] tracking-tight">
							{t("value.heading")}
						</h2>
					</div>
					<div className="lg:col-span-6 xl:col-span-5 flex justify-end">
						<p className="text-gray-500 font-satoshi text-lg md:text-xl leading-relaxed max-w-sm">
							{t("value.description")}
						</p>
					</div>
				</div>
			...
			<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10 lg:gap-x-16 lg:gap-y-24 items-start">
				...
				<div className="flex flex-col gap-16 lg:gap-24">
					...
					<div className="flex flex-col border-b border-black/10 dark:border-white/10 pb-10 group cursor-default">
						<span className="text-xl md:text-2xl font-switzer font-medium text-gray-400 mb-20">
							{t("value.items.3.number")}
						</span>
						<h3 className="text-2xl md:text-3xl font-switzer font-medium mb-6">
