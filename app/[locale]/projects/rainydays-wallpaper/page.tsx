					...
					<div className="flex flex-wrap gap-4">
						...
						{projectConfig.figmaLink && (
							<a
								...
								target="_blank"
								rel="noopener noreferrer"
								className="inline-flex items-center gap-3 px-6 py-3 bg-white dark:bg-neutral-900 text-black dark:text-white border border-neutral-200 dark:border-neutral-800 rounded-full font-work-sans font-medium transition-all hover:scale-105 active:scale-95 group shadow-sm"
							>
								<svg
									viewBox="0 0 38 57"
									className="w-4 h-5"
					...
					{projectConfig.gallery.length > 0 && (
						<div className="mt-12 md:mt-16 grid grid-cols-1 md:grid-cols-12 gap-y-10 md:gap-y-14 gap-x-10 auto-rows-min pb-12">
							{projectConfig.gallery.map((media, i) => {
								...
								return (
									<div
										// biome-ignore lint/suspicious/noArrayIndexKey: using index because media src might be same for placeholders
										key={media.src + i}
