		...
		<>
			<div className="w-full">
				<div className="px-6 md:px-12.5 mb-12 mt-6 md:mt-37.5">
					...
					<p className="text-gray-500 font-quicksand text-base md:text-lg">
						{t(`${id}.subtitle`)}
					</p>
				</div>
				...
				<div className="px-6 md:px-12.5">
					...
					<div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 mb-32 border-b border-black/10 dark:border-white/10 pb-32">
						...
						<div className="flex flex-col justify-between">
							<h2 className="text-3xl md:text-5xl lg:text-6xl font-work-sans font-medium leading-[1.2] tracking-tight mb-16 lg:mb-32">
							...
							<div className="grid grid-cols-2 gap-y-10 gap-x-4">
								<div>
									<p className="text-gray-500 font-quicksand mb-2">Client:</p>
									<p className="font-work-sans font-bold">
										{t(`${id}.meta.client`)}
									</p>
								</div>
								<div>
									<p className="text-gray-500 font-quicksand mb-2">Industry:</p>
									<p className="font-work-sans font-bold">
										{t(`${id}.meta.industry`)}
									</p>
								</div>
								<div>
									<p className="text-gray-500 font-quicksand mb-2">Category:</p>
									<p className="font-work-sans font-bold">
										{tCat(projectConfig.categoryId)}
									</p>
								</div>
								<div>
									<p className="text-gray-500 font-quicksand mb-2">Duration:</p>
									<p className="font-work-sans font-bold">
										{t(`${id}.meta.duration`)}
									</p>
								</div>
						...
						<div className="flex flex-col gap-10">
							<p className="text-gray-500 font-quicksand text-lg md:text-xl leading-relaxed max-w-lg">
					...
					<div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-14 py-12">
						...
						<div className="lg:col-span-9">
							<h3 className="text-3xl md:text-4xl lg:text-5xl font-work-sans font-medium leading-[1.2] tracking-tight text-gray-500 mb-16 max-w-4xl">
							...
							<div className="flex flex-col gap-8 max-w-3xl">
								{t
									...
									.map((point: string, i: number) => (
										...
										>
											<span className="text-gray-400 font-quicksand text-base">
												/0{i + 1}
											</span>
					...
					<div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-20 bg-[#F2F2F2] dark:bg-[#111111] mt-32 md:mt-48 pb-16">
						...
						<div className="lg:col-span-9">
							<h3 className="text-3xl md:text-4xl lg:text-5xl font-work-sans font-medium leading-[1.2] tracking-tight mb-16 max-w-4xl text-[#111111] dark:text-[#f2f2f2]">
							...
							<div className="flex flex-col gap-6 md:gap-8 max-w-3xl">
								{t.raw(`${id}.result.list`).map((item: string, i: number) => (
									...
									>
										<span className="md:col-span-2 text-gray-400 font-quicksand text-base">
											/0{i + 1}
										</span>
										<p className="md:col-span-10 text-gray-500 font-quicksand text-base md:text-lg leading-relaxed">
											{item}
										</p>
									</div>
								))}
			...
			<section className="pt-24 md:pt-32 pb-20 mt-32 border-t border-black/10 dark:border-white/10">
				<div className="px-6 md:px-12.5">
					...
					<div className="grid grid-cols-1 md:grid-cols-12 gap-10 lg:gap-16">
						...
						<div className="hidden md:flex md:col-span-4 items-end pb-4 font-work-sans font-medium text-gray-600 dark:text-gray-400">
							VIEW DETAILS
						</div>
