	...
	return (
		<>
			...
			<section className="px-6 pt-20 lg:pt-24 md:px-12.5 mb-12">
				<h1 className="text-6xl md:text-8xl lg:text-[120px] font-work-sans font-medium tracking-tight mb-6">
					{t("title")}
				</h1>
			...
			<section className="px-6 md:px-12.5 mb-10 lg:mb-12">
				<div className="flex flex-col items-center gap-4 mb-20 text-center">
					...
					<h2 className="text-5xl md:text-6xl lg:text-[80px] font-work-sans font-medium tracking-tight leading-[1.1]">
						{t("portfolio.heading")}
					</h2>
					<p className="text-gray-500 font-quicksand text-base md:text-lg max-w-[65%] mt-2">
